...
/*   Updated: 2024/01/29 22:21:30 by jorvarea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int optimal_move_index(t_list **a, t_list **b, int *moves_a, int *moves_b)
{
    int min_moves;
    int min_tmp;
    int min_moves_index;
...
static void execute_optimal_move(t_list **a, t_list **b, t_moves *moves, int optimal_index)
{
